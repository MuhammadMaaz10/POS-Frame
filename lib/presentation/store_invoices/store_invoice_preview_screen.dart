...
class StoreInvoicePreviewScreen extends StatelessWidget {
        ...
        return Container(
          ...
          child: SingleChildScrollView(
            ...
            children: [
              ...
              // Items List
              ...controller.selectedItems.entries.map((entry) {
                final item = entry.key;
                final quantity = entry.value;
                final itemTotal = controller.calculateItemTotal(item);
                final itemTax = controller.calculateItemTax(item);
  ...
  String _getTaxPercentageText(item) {
    if (item.vatCategoryPercentage is String) {
      return item.vatCategoryPercentage;
    } else if (item.vatCategoryPercentage is num) {
      return item.vatCategoryPercentage.toString();
    }
    return "0";
  }
}
